...
// Routes and packet types come from the client packet headers (packets/api_*.cs),
// not from the route name - Rust is behind the client and doesn't declare every
// route the client calls. Rust supplies only the stateless classification: a
// route is emitted iff its Rust handler used static_response and never touched
// UserRepository (or, for a route Rust doesn't declare at all, iff some other
// Rust-static route uses the same ReqPacket_/ResPacket_ pair). Stateful endpoints
// are handled in cycles 3 and 4.
// NOT IN CLIENT lines are routes Rust declares and classifies stateless that the
// client does not declare at all. Re-running the generator reproduces the same
// comment-outs.
...
public static class StaticRoutes
{
    public static IEndpointRouteBuilder MapStaticPackets(this IEndpointRouteBuilder app)
    {
        ...
        app.MapPacket<ReqPacket_BattlePassRewardAll, ResPacket_BattlePassRewardAll>("/api/BattlePassReward_ALL");
        ...
        app.MapPacket<ReqPacket_EnterExpDungeon, ResPacket_EnterExpDungeon>("/api/EnterExpDungeonv2");
        ...
        app.MapPacket<ReqPacket_EnterThreadDungeon, ResPacket_EnterThreadDungeon>("/api/EnterThreadDungeonv2");
        ...
        app.MapPacket<ReqPacket_ExitExpDungeon, ResPacket_ExitExpDungeon>("/api/ExitExpDungeonv2");
        ...
        app.MapPacket<ReqPacket_SkipExpDungeon, ResPacket_SkipExpDungeon>("/api/SkipExpDungeonv2");
        app.MapPacket<ReqPacket_SkipThreadDungeon, ResPacket_SkipThreadDungeon>("/api/SkipThreadDungeon");
        app.MapPacket<ReqPacket_SkipThreadDungeon, ResPacket_SkipThreadDungeon>("/api/SkipThreadDungeonv2");

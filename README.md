...
| `Auth:RateLimitPerMinute` | `Auth__RateLimitPerMinute` | `600` | Per-IP fixed-window rate limit on the unauthenticated `/auth/*` routes; exceeding it returns 429. Deliberately loose - the launcher polls at 1/s during login |
